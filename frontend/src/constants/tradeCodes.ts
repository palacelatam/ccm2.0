...
export const CENTRAL_BANK_TRADE_CODES: TradeCode[] = [
  ...
  { code: '20080', concept: 'Egresos por liquidación de Cuentas de Resultado y por Constitución de Reservas con utilidades en moneda extranjera.', type: 'expense' },
  { code: '20080', concept: 'Egresos por Turismo.', type: 'expense' },
  ...
  { code: '20080', concept: 'Egresos no contemplados en otros Códigos de Operaciones de Cambios.', type: 'expense' },
